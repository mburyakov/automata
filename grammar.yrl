...
ExtendsList -> Type BrVarList : [{'$1','$2','$1'}].
ExtendsList -> Type BrVarList 'as' Type : [{'$1','$2','$4'}].
ExtendsList -> Type BrVarList ',' ExtendsList : [{'$1','$2','$1'}|'$4'].
ExtendsList -> Type BrVarList 'as' Type ',' ExtendsList : [{'$1','$2','$4'}|'$6'].
BrTypedIdList -> '(' ')' : [].
...
ClassMember -> ClassMemberName BrVarList '->' DotTokens: {'member','$1','$2','$4'}.
%ClassMember -> ClassMemberName '->' DotTokens: {'member','$1',[],'$3'}.
ClassMemberName -> atom : value_of('$1').
DotTokens -> Tokens dot : parse_ans(erl_parse:parse_exprs('$1' ++ ['$2'])).
Tokens -> Token : ['$1'].
